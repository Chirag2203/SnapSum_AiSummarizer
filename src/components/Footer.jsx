...
const Footer = () => {
  return (
    <div className='w-full flex px-16 py-12 gap-12 '>
      <div className='flex flex-col items-start w-1/3 summary_box'>
      ...
      <div className='flex flex-col items-start summary_box w-1/3'>
